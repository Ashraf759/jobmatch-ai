...
- Ashraf Parvez Mohammad
- Bharath Dara

## Project Overview

JobMatch AI helps job seekers organize their job applications in one centralized system while also providing AI-assisted resume and job-description analysis.
...
The project is being developed using two-week Scrum sprints.
